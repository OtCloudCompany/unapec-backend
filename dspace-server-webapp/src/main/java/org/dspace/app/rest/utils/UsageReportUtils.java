...
public class UsageReportUtils {
    ...
    public UsageReportRest createUsageReport(Context context, DSpaceObject dso, String reportId)
        ...
        return createUsageReport(context, dso, reportId, null, null);
    }
    ...
    private UsageReportRest resolveTotalVisits(Context context, DSpaceObject dso)
        throws SQLException, IOException, ParseException, SolrServerException {
        return resolveTotalVisits(context, dso, null, null);
    }

    private UsageReportRest resolveTotalVisits(Context context, DSpaceObject dso,
                                               LocalDateTime startDate, LocalDateTime endDate)
        throws SQLException, IOException, ParseException, SolrServerException {
        Dataset dataset = this.getDSOStatsDataset(context, dso, 1, dso.getType(), startDate, endDate);
    ...
    private UsageReportRest resolveTotalVisitsPerMonth(Context context, DSpaceObject dso)
        throws SQLException, IOException, ParseException, SolrServerException {
        return resolveTotalVisitsPerMonth(context, dso, null, null);
    }
    ...
    private UsageReportRest resolveTotalVisitsPerMonth(Context context, DSpaceObject dso,
        ...
        if (startDate != null && endDate != null) {
            timeAxis.setDateInterval("month", startDate, endDate);
        } else {
    ...
    private UsageReportRest resolveTotalDownloads(Context context, DSpaceObject dso)
        ...
        return resolveTotalDownloads(context, dso, null, null);
    }
    ...
    private UsageReportRest resolveTotalDownloads(Context context, DSpaceObject dso,
        ...
        if (dso instanceof org.dspace.content.Bitstream) {
            return this.resolveTotalVisits(context, dso, startDate, endDate);
        }

        if (dso instanceof org.dspace.content.Item) {
            Dataset dataset = this.getDSOStatsDataset(context, dso, 1, Constants.BITSTREAM, startDate, endDate);
    ...
    private UsageReportRest resolveTopCountries(Context context, DSpaceObject dso)
        throws SQLException, IOException, ParseException, SolrServerException {
        return resolveTopCountries(context, dso, null, null);
    }
    ...
    private UsageReportRest resolveTopCities(Context context, DSpaceObject dso)
        throws SQLException, IOException, ParseException, SolrServerException {
        return resolveTopCities(context, dso, null, null);
    }
    ...
    private Dataset getDSOStatsDataset(Context context, DSpaceObject dso, int facetMinCount, int dsoType)
        throws SQLException, IOException, ParseException, SolrServerException {
        return getDSOStatsDataset(context, dso, facetMinCount, dsoType, null, null);
    }
    ...
    private Dataset getDSOStatsDataset(Context context, DSpaceObject dso, int facetMinCount, int dsoType,
        ...
        addDateFilter(statsList, startDate, endDate);
    ...
    private Dataset getTypeStatsDataset(Context context, DSpaceObject dso, String typeAxisString, int typeAxisMax,
                                        int facetMinCount)
        throws SQLException, IOException, ParseException, SolrServerException {
        return getTypeStatsDataset(context, dso, typeAxisString, typeAxisMax, facetMinCount, null, null);
    }

    private Dataset getTypeStatsDataset(Context context, DSpaceObject dso, String typeAxisString, int typeAxisMax,
                                        int facetMinCount, LocalDateTime startDate, LocalDateTime endDate)
        throws SQLException, IOException, ParseException, SolrServerException {
    ...
    private void addDateFilter(StatisticsListing statsList, LocalDateTime startDate, LocalDateTime endDate) {
        if (startDate != null || endDate != null) {
            if (startDate == null || endDate == null) {
